...
#define CONFIGURATION_SECRET_MAX_LENGTH 65
#define CONFIGURATION_HOSTNAME_MAX_LENGTH 33
#define CONFIGURATION_PASSWORD_MAX_LENGTH 65
#define CONFIGURATION_SSID_MAX_LENGTH 33
