...
#define CONFIGURATION_SECRET_MAX_LENGTH 66
#define CONFIGURATION_HOSTNAME_MAX_LENGTH 34
#define CONFIGURATION_PASSWORD_MAX_LENGTH 66
#define CONFIGURATION_SSID_MAX_LENGTH 34
