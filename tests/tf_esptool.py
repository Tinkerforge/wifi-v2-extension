...
#
#
# This file was taken from the repository above and made compatible to be used
# with Master Brick and Brick Viewer.
#
# We try to stay as compatible as possible to the esptool.py file, so we can easily
# update later on.
...
class ESPROM:
    ...
    def __init__(self, port = 0, baud = ESP_ROM_BAUD):
        self._port = TFSerial(port) # serial.Serial(port)
